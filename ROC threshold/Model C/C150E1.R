...
thres.ctrl.list <- c(0.6, 0.1, 0.05, 0.01, 0.005, 0.002, 0.001, 0)
...
save(roc, file=paste(save.path,"/E1.C.150.RunInd",run.ind,".Rdata",sep=""))
...
save(e1.runtime, file=paste(runtime.path,
                             "/E1time.C.150.Runind",run.ind,".Rdata",sep=""))
