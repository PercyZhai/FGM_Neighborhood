...
file.path <- "GitHub/abide/time_series/outputs/cpac/nofilt_noglobal/rois_aal/"
file.list <- list.files(file.path, "NYU?")
phenotypic <- read.csv("GitHub/GroupLasso/Real data analysis/Phenotypic_V1_0b_preprocessed1.csv")
...
save(h.1, h.2, file="Github/GroupLasso/Real data analysis/time_series.RData")
