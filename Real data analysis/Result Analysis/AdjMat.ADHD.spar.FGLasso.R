...
#load("Desktop/GroupLasso/Real data analysis/Results/ADHD/G.spa.ctrl.ADHD.FGLasso.RData")
#load("Desktop/GroupLasso/Real data analysis/Results/ADHD/G.spa.ctrl.control.FGLasso.RData")
load("Results/ADHD/G.spa.ctrl.ADHD.FGLasso.RData")
load("Results/ADHD/G.spa.ctrl.control.FGLasso.RData")
diag(G.ADHD.sym) <- 0
